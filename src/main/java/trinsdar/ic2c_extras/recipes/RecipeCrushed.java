...
public class RecipeCrushed {
    ...
    public static void recipesCrushed() {
        ...
        addAllRecipes(GTMaterial.Cryolite, new ItemStack[]{MaterialGen.getStack(GTMaterial.Cryolite, purifiedCrushedOre, 1), MaterialGen.getStack(GTMaterial.Cryolite, tinyDust, 1), new ItemStack(Registry.stoneDust)}, GT.getDust(GTMaterial.Cryolite, 1), MaterialGen.getStack(GTMaterial.Cryolite, tinyDust, 1));
        addAllRecipes(GTMaterial.Galena, new ItemStack[]{MaterialGen.getStack(GTMaterial.Galena, purifiedCrushedOre, 1), MaterialGen.getStack(GTMaterial.Galena, tinyDust, 1), new ItemStack(Registry.stoneDust)}, GT.getDust(GTMaterial.Galena, 1), new ItemStack(Registry.silverTinyDust, 1), new ItemStack(Registry.leadTinyDust));
        ...
        addAllRecipes(GTMaterial.Sheldonite, new ItemStack[]{MaterialGen.getStack(GTMaterial.Sheldonite, purifiedCrushedOre, 1), MaterialGen.getStack(GTMaterial.Sheldonite, tinyDust, 1), new ItemStack(Registry.stoneDust)}, GT.getDust(GTMaterial.Sheldonite, 1), MaterialGen.getStack(GTMaterial.Nickel, tinyDust, 1), MaterialGen.getStack(GTMaterial.Platinum, tinyDust, 1));
