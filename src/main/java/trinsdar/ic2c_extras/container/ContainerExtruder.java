...
public class ContainerExtruder extends ContainerTileComponent<TileEntityExtruder> {
    public ContainerExtruder(InventoryPlayer player, TileEntityExtruder tile) {
        super(tile);
