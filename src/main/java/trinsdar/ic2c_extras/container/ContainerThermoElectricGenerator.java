...
public class ContainerThermoElectricGenerator extends ContainerComponent<TileEntityThermoElectricGenerator> {
    ...
    public ContainerThermoElectricGenerator(TileEntityThermoElectricGenerator tile, Player player, int windowId) {
