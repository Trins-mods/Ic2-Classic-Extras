...
public class Registry
{
    ...
    nearDepletedUOXCell = new ItemMiscs("nearDepletedUOXCell", 18,false),
    nearDepletedPlutoniumCell = new ItemMiscs("nearDepletedPlutoniumCell", 19, false),
    nearDepletedMOXCell = new ItemMiscs("nearDepletedMOXCell", 20, false),
    nearDepletedThroiumCell = new ItemMiscs("nearDepletedThroiumCell", 21, false),
    nearDepletedCaliforniumCell= new ItemMiscs("nearDepletedCaliforniumCell", 22, false),
    reEnrichedUOXCell = new ItemMiscs("reEnrichedUOXCell", 23,false),
    reEnrichedPlutoniumCell = new ItemMiscs("reEnrichedPlutoniumCell", 24, false),
    reEnrichedMOXCell = new ItemMiscs("reEnrichedMOXCell", 25, false),
    reEnrichedThroiumCell = new ItemMiscs("reEnrichedThroiumCell", 26, false),
    reEnrichedCaliforniumCell= new ItemMiscs("reEnrichedCaliforniumCell", 27, false),
