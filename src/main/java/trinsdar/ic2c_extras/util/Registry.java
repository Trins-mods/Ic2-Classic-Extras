...
public class Registry {
    ...
    public static final BlockMachine oreWashingPlant = registerBlock(new BlockMachine("oreWashingPlant", Ic2cExtrasLang.oreWashingPlant));
    public static final BlockMachine thermalCentrifuge = registerBlock(new BlockMachine("thermalCentrifuge", Ic2cExtrasLang.thermalCentrifuge));
    public static final BlockMachine thermalWasher = registerBlock(new BlockMachine("thermalWasher", Ic2cExtrasLang.thermalWasher));
    ...
    public static final BlockMachine impellerizedRoller = registerBlock(new BlockMachine("impellerizedRoller", Ic2cExtrasLang.impellerizedRoller));
    public static final BlockMachine liquescentExtruder = registerBlock(new BlockMachine("liquescentExtruder", Ic2cExtrasLang.liquescentExtruder));
    public static final BlockMachine plasmaCutter = registerBlock(new BlockMachine("plasmaCutter", Ic2cExtrasLang.plasmaCutter));
