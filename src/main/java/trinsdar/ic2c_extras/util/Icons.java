...
public class Icons
{
    ...
    {
        addSprite(new Sprites.SpriteData("ic2c_extras_blocks", "ic2c_extras:textures/sprites/blocks.png", new Sprites.SpriteInfo(4, 4)));
        ...
        addTextureEntry(new Sprites.TextureEntry("ic2c_extras_blocks", 0, 0, 4, 4));
