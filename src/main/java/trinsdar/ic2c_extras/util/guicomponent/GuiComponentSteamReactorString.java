...
public class GuiComponentSteamReactorString extends GuiComponent {
    ...
    public void drawFrontground(GuiIC2 gui, int mouseX, int mouseY) {
        gui.drawString(Ic2cExtrasLang.REACTOR_STEAM.getLocalizedFormatted(reactor.getReactorEUEnergyOutput()), this.getPosition().getX() + 3, this.getPosition().getY() + 2, Color.cyan.hashCode());
    }
}
