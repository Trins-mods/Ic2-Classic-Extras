...
public class GuiComponentNuclearReactorEuPerTick extends GuiComponent {
    ...
    public void drawFrontground(GuiIC2 gui, int mouseX, int mouseY) {
        gui.drawString(Ic2cExtrasLang.REACTOR_EU.getLocalizedFormatted(reactor.getReactorEUEnergyOutput()), this.getPosition().getX() + 3, this.getPosition().getY() + 2, Color.cyan.hashCode());
    }
}
